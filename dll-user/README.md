...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log(typeof __webpack_require__(/*! preact */ 8));
...
chunk    {0} output.js (main) 23.6 kB [rendered]
    ...
    [8] ../~/preact/dist/preact.js 23 kB {0} [built]
        cjs require preact [0] ./example.js 9:19-36
     + 7 hidden modules
```
...
chunk    {0} output.js (main) 23.6 kB [rendered]
    > main [0] ./example.js 
    [0] ./example.js 213 bytes {0} [built]
    [3] ../~/preact/dist/preact.js 23 kB {0} [built]
        cjs require preact [0] ./example.js 9:19-36
     + 7 hidden modules

WARNING in output.js from UglifyJs
Condition always true [../~/preact/dist/preact.js:2,0]
```